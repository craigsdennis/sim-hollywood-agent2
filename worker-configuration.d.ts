/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 326c952974e3cb30992b9ce9b72e1e45)
// Runtime types generated with workerd@1.20250803.0 2025-07-05 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_API_TOKEN: string;
		HollywoodAgent: DurableObjectNamespace<import("./worker/index").HollywoodAgent>;
		ReporterAgent: DurableObjectNamespace<import("./worker/index").ReporterAgent>;
